               ...
               <form onSubmit={(e)=>this.createEmployee(e)}>
                ...
                {/* <label htmlFor="role">
                    Select the Role:
                        ...
                        <button onClick={()=>this.handleSubmit(this.email.current.value)} type="submit"  name="submit"  className="btn btn-success reg" readOnly={true} style={{"height":"50px"}}>Register Now</button>
